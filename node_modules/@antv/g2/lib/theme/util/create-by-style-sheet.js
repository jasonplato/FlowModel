    ...
    return {
                    ...
                    selected: {
                        style: function (element) {
                            ...
                            if (coordinate.isPolar && coordinate.isTransposed) {
                                var _a = (0, graphics_1.getAngle)(element.getModel(), coordinate), startAngle = _a.startAngle, endAngle = _a.endAngle;
        ...
        components: {
            axis: {
                ...
                circle: {
                    title: null,
                    grid: (0, util_1.deepMix)({}, axisStyles.grid, { line: { type: 'line' } }),
                },
                radius: {
                    title: null,
                    grid: (0, util_1.deepMix)({}, axisStyles.grid, { line: { type: 'circle' } }),
                },
            },
            legend: {
                common: legendStyles,
            ...
            tooltip: {
                ...
                // tooltip dom 样式
                domStyles: (_a = {},
                    _a["".concat(component_1.TOOLTIP_CSS_CONST.CONTAINER_CLASS)] = {
                        position: 'absolute',
                        visibility: 'hidden',
                        zIndex: 8,
                    ...
                    _a["".concat(component_1.TOOLTIP_CSS_CONST.TITLE_CLASS)] = {
                        marginBottom: '12px',
                        marginTop: '12px',
                    },
                    _a["".concat(component_1.TOOLTIP_CSS_CONST.LIST_CLASS)] = {
                        margin: 0,
                        listStyleType: 'none',
                        padding: 0,
                    },
                    _a["".concat(component_1.TOOLTIP_CSS_CONST.LIST_ITEM_CLASS)] = {
                        listStyleType: 'none',
                        padding: 0,
                        marginBottom: '12px',
                        marginTop: '12px',
                    ...
                    _a["".concat(component_1.TOOLTIP_CSS_CONST.MARKER_CLASS)] = {
                        width: '8px',
                        height: '8px',
                        borderRadius: '50%',
                    ...
                    _a["".concat(component_1.TOOLTIP_CSS_CONST.VALUE_CLASS)] = {
                        display: 'inline-block',
                        float: 'right',
                        marginLeft: '30px',
                    },
