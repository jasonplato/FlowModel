...
function getRectWithCornerRadius(points, coordinate, radius) {
    ...
    // 获取 四个关键点
    var _h = tslib_1.__spreadArray([], points, true), p0 = _h[0], p1 = _h[1], p2 = _h[2], p3 = _h[3];
    var _j = typeof radius === 'number' ? Array(4).fill(radius) : radius, r1 = _j[0], r2 = _j[1], r3 = _j[2], r4 = _j[3];
    if (coordinate.isTransposed) {
        _a = swap(p1, p3), p1 = _a[0], p3 = _a[1];
        _b = [r4, r1, r2, r3], r1 = _b[0], r2 = _b[1], r3 = _b[2], r4 = _b[3];
    }
    /**
     * 存在镜像
     */
    if (coordinate.isReflect('y')) {
        ...
        _d = swap(p2, p3), p2 = _d[0], p3 = _d[1];
    }
    if (coordinate.isReflect('x')) {
        _e = swap(p0, p3), p0 = _e[0], p3 = _e[1];
        _f = swap(p1, p2), p1 = _f[0], p2 = _f[1];
    }
    var path = [];
    /**
     *  p1 → p2
    ...
    _g = parseRadius([r1, r2, r3, r4], Math.min(abs(p3.x - p0.x), abs(p1.y - p0.y))).map(function (d) { return abs(d); }), r1 = _g[0], r2 = _g[1], r3 = _g[2], r4 = _g[3];
    if (p0.y < p1.y /** 负数情况 */) {
